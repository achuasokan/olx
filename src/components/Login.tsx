          ...
          <div className="sm:flex sm:items-start">
            ...
            <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
              <div className="mt-2">
                ...
                <div onClick={handleLogin} className='flex border-2 border-gray-300 p-2 rounded-md cursor-pointer mt-4'>
                  <img src={google} className='w-6 h-6'  alt="phone icon"/>
